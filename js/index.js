  $(document).ready(function() {
          $('#homepage').fullpage({
            ...
            // fitToSectionDelay: 2000,
    				anchors: ['home', 'about-us', 'what-we-do', 'our-work', 'contact1', 'work1', 'work2', 'work3', 'work4'],
    				sectionsColor: ['#f2f2f2', '#1BBC9B', '#7E8F7C', '#C63D0F','#C63D0F','#C63D0F','#C63D0F','#C63D0F','#C63D0F'],
